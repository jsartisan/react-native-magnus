...
import { getStyle, styles } from './select.style';
...
const Select = forwardRef<SelectRef, SelectProps>((incomingProps, ref) => {
  ...
  const renderSearchbar = () => {
    ...
    if (searchInputElement) {
      return cloneElement(searchInputElement, mandatoryProps);
    }
  ...
  const renderFooter = () => {
    ...
    if (submitButtonElement) {
      return cloneElement(submitButtonElement, mandatoryProps);
    }
