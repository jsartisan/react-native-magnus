...
export const getStyle = (theme: any, props: any) => {
  ...
  computedStyle.highlightContainer = {
    ...
    height: getThemeProperty(theme.fontSize, props.size) + 6,
    width: getThemeProperty(theme.fontSize, props.size) + 6,
    alignItems: 'center',
    justifyContent: 'center',
    top: -3,
    left: -3,
    borderRadius: getThemeProperty(theme.fontSize, props.size),
    zIndex: 1,
    position: 'absolute',
  };
