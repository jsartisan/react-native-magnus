  ...
  <SafeAreaView style={{ flex: 1 }}>
    <Div flex={1}>
      <Div px="xl" pt="2xl" flex={1} bg="pink100">
        ...
        <Text mt="sm" color="brown100" fontSize="md" fontWeight="bold" w="60%">Discover the world’s top Designers & Creatives.</Text>
      ...
      <Div p="lg">
        <Button py="lg" bg="twitter"  block color="white" prefix={<Icon fontSize="md"mr="md" name="twitter" color="white" />}>Sign-in with Twitter</Button>
        <Button mt="md" py="lg" bg="facebook"  block color="white" prefix={<Icon  fontSize="lg"mr="md" name="facebook-square" color="white" />}>Sign-in with Facebook</Button>
        <Button mt="md" py="lg" bg="google" justifyContent="center" alignItems="center" block color="white" prefix={<Icon fontSize="lg"mr="md" name="google" color="white" />}>Sign-in with Google</Button>
